...
public class GeorgeParsedSql {
     ...
     */
    public GeorgeParsedSql(String originalSql) {
     ...
     * length 2 George备注：这个indexs是参数形参在SQL语句中的开始字符位置和结束字符位置，不是
     * 参数对应的PreparedStatement 中的?占位符索引值。
     */
